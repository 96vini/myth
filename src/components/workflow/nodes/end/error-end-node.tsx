...
export function ErrorEndNode({ id, data, selected }: NodeProps<EndNodeData>) {
  const [isEditing, setIsEditing] = useState(data.isEditing || false)
  const [label, setLabel] = useState(data.label || "Erro")
